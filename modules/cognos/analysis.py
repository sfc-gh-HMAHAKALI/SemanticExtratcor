...
def audit_relationships(
    ...
    # count (by 25 in the ResMed SPU model) and misstates the finding.
...
def audit_data_sources(parsed: dict) -> dict[str, Any]:
    ...
    inferring from table-name prefixes -- several query subjects in the ResMed
